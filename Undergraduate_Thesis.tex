...
%integral 0 to 1.905 integral 0 to 2pi integral 0 to 1.27 of (rho/(2*pi*sqrt(rho^2 + z^2)*z + 2*pi*(rho^2 + %z^2))) drho dphi dz
%(3.7E5)(0.0687)(29.15 / 1.49E-23)(9/25)(2.04E-28)(1/9.65)(1.068)
...
\begin{document}
	...
	Applying Equation 6 to our function in Equation 5 yields:
	...
	\begin{thebibliography}{1}
		...
		\bibitem{cite01} N. Aghanim et al. (Planck Collaboration). 2018. Planck 2018 results. VI. Cosmological parameters. arXiv:1807.06209 
		\bibitem{cite02} J. I. Collar. 2017. Applications of an $^{88}$Y/Be photo-neutron calibration source
		to Dark Matter and Neutrino Experiments. arXiv:1303.2686
		\bibitem{cite03} Alvaro E. Chavarria. 2012. Calibrating the energy response of bubble chambers to $^{19}$F recoils by taking advantage of the elastic scattering resonances.
		\bibitem{cite04} C. Amole et al. (PICO Collaboration). 2018. Measurements and models of the efficiency of bubble nucleation by nuclear and electron recoils in superheated liquids. 	
		\bibitem{cite05} A. Robinson. 2015. Photoneutron Source Characterization and Neutron Simulations.
		\bibitem{cite07} C. Amole et al. (PICO Collaboration). 2019. Dark Matter Search Results from the  Complete Exposure of the PICO-60 C$_{3}$F$_{8}$ Bubble Chamber. arXiv:1902.04031 
		\bibitem{cite08} C. Amole et al. (PICO Collaboration). 2017. Dark Matter Search Results from the PICO-60 C$_{3}$F$_{8}$ Bubble Chamber. arXiv:1702.07666 
		\bibitem{cite09} C. Amole et al. (PICO Collaboration). 2016. Improved dark matter search results from PICO-2L Run 2. arXiv:1601.03729
		\bibitem{cite011} A. Wattenberg. Photo-Neutron Sources. Preliminary Report No. 6. United States: N. p., 1949. Web. doi:10.2172/4448374.
		\bibitem{cite012} N. Soppera, M. Bossant, E. Dupont, "JANIS 4: An Improved Version of the NEA Java-based Nuclear Data Information System", Nuclear Data Sheets, Volume 120, June 2014, Pages 294-296.
		\bibitem{cite013} G. Giacomelli. 2006. Introduction to the Workshop "30 years of bubble chamber physics". arXiv:0604152
	...
	\begin{figure}[H]%
		\centering
		\subfloat[]{{\includegraphics[scale = 0.28]{Images/dbc_geant.png} }}%
		\qquad
	...
	\begin{figure}[H]%
		\centering
		\subfloat[]{{\includegraphics[scale = 0.24]{Images/linear_top_view.png} }}%
		\qquad
		\subfloat[]{{\includegraphics[scale = 0.24]{Images/arc_top_view.png} }}%
		\qquad
		\subfloat[]{{\includegraphics[scale = 0.24]{Images/iso_top_view.png} }}%
