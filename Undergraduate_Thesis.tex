...
%		\caption{\label{tab:table-name} Expected average bubble multiplicities for a range of threshold energies.}
	...
	\begin{thebibliography}{1}
		...
		\bibitem{1702.07666} C. Amole et al. (PICO Collaboration). 2017. Dark Matter Search Results from the PICO-60 C$_{3}$F$_{8}$ Bubble Chamber. Phys. Rev. Lett. 118, 251301 (2017). arXiv:1702.07666 
		\bibitem{1601.03729} C. Amole et al. (PICO Collaboration). 2016. Improved dark matter search results from PICO-2L Run 2. Phys. Rev. D 93, 061101 (2016). arXiv:1601.03729
